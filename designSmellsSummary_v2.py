...
for fname in outputs:
    if fname.endswith('-out'):
        path = '/Users/isdeniz/Downloads/analysis7-14/' + fname + '/' + 'designCodeSmells.csv'
        ...
        smellsSummary.to_csv('/Users/isdeniz/Documents/results/designCodeSmellsSummary.csv',mode='a',index=False,header=False)  
